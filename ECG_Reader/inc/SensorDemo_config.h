...
#define DEFAULT_NUM_GATT_ATTRIBUTES 12
...
#else  // No Humidity char
#define NUM_APP_GATT_ATTRIBUTES (25)
#endif
...
#define MAX_NUMBER_ATTRIBUTES_RECORDS_SERVICE_1 (25) 
...
#else
#define ATT_VALUE_ARRAY_SIZE    (43 + 240 + 200 + OTA_ATT_VALUE_ARRAY_SIZE) //(GATT + GAP) = 43 (Device Name: BlueNRG) + Acceleration (Acceleration (27) + Free Fall (21) characteristics) +  Environmental Sensor (Temperature (28), Pressure (29)  characteristics)  Services
#endif 
